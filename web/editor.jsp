<%-- 
    Document   : editor
    Created on : 20/11/2009, 12:22:14
    Author     : fernando
--%>
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        <!--DWLayoutTable-->
                                        <tr>
                                            <td width="544" height="14" valign="top"><div align="left"><span class="style9"> Bem vindo, <%=editor.getNome()%>.</span></div></td>
                                        </tr>
                                        <tr>
                                            <td height="19" valign="top"><div align="left"> Essa é a área dedicada aos editores cadastrados no Jornal ZOI </div></td>
                                        </tr>
                                    </table>
                                </td>
                                <td>&nbsp;</td>
