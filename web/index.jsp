<%-- 
    Document   : index
    Created on : 30/10/2009, 11:11:10
    Author     : fernando
--%>
...
noticias = daoNoticia.buscarUltimas();
%>
                    ...
                    <td width="668" valign="top">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td width="544" valign="top" bgcolor="#FFFFFF"><div align="center"><strong>&Uacute;LTIMAS NOT&Iacute;CIAS </strong></div></td>
                                <td width="102"></td>
                            </tr>
                            <tr>
                                <td height="13"></td>
