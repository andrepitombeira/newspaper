<%-- 
    Document   : editorAdicionarSecao
    Created on : 18/11/2009, 10:44:45
    Author     : fernando
--%>
...
<%
        ...
        jornal.entidades.Secao secao = (jornal.entidades.Secao) session.getAttribute("secao");
                    ...
                    <td width="668" valign="top">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td width="544" valign="top" bgcolor="#FFFFFF"><div align="center"><strong> Adicionar Seção </strong></div></td>
                                <td width="102"></td>
                            </tr>
                            <tr>
                                <td height="13"></td>
                                        ...
                                        <!--DWLayoutTable-->
                                            <tr>
                                             <td width="544" height="276" valign="top">
                                                 ...
                                                 <form id="form2" name="form2" method="post" action="EditorAdicionarSecaoServlet">
                                                <p>
                                                    <label>Título :<br />
                                                        <input name="titulo" type="text" size="40" value="<%=titulo%>"/>
                                                </label>
                                                </p>
                                                <p>
                                                    <label>Descrição :<br />
                                                        <input name="descricao" type="text" size="40" value="<%=descricao%>"/>
                                                    </label>
                                                </p>
                                                <p>
                                                            <div align="left">
