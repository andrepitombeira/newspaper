...
public class JornalistaListarNoticiasServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            if(user != null && user instanceof Jornalista){
                Jornalista jornalista = (Jornalista) user;
                NoticiaDAO dao = new NoticiaDAO();
                jornalista.setNoticias(dao.buscarPorIdJornalista(jornalista.getId()));
