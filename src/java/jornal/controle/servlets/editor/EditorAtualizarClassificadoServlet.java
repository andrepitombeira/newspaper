...
public class EditorAtualizarClassificadoServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(user != null && user instanceof Editor){
                ...
                Classificado classificado = editor.getClassificado(id);
                if(classificado != null){
                    ...
                    session.setAttribute("error", "Voce nao tem permissao para atualizar esse classificado.");
